...
%                     {'CZ-AVG','W N1 N2 N3 R','0.5 2; 4 7;8 12;13 30;30 45','3','A','1.5'});
...
% ===================== 저장을 위해 일시적으로 만듬 =========================
% ===================== 한 체널만 가능하도록 만든다 =========================
                    Spectral_DATA.Frequency = F_temp ;
                    if s == 1
                        Spectral_DATA.Power_W = p ;
                    elseif s == 2
                        Spectral_DATA.Power_N1 = p ;
                    elseif s == 3
                        Spectral_DATA.Power_N2 = p ;
                    elseif s == 4
                        Spectral_DATA.Power_N3 = p ;
                    else
                        Spectral_DATA.Power_R = p ;
                    end
                    save(['results\Power_' Head.FileName(1:end-4)], 'Spectral_DATA', '-v7.3');
