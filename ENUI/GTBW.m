function varargout = GTBW(varargin)
% GTBW M-file for GTBW.fig
%      GTBW, by itself, creates a new GTBW or raises the existing
%      singleton*.
%
%      H = GTBW returns the handle to a new GTBW or the handle to
%      the existing singleton*.
%
%      GTBW('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GTBW.M with the given input arguments.
%
%      GTBW('Property','Value',...) creates a new GTBW or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GTBW_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GTBW_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GTBW

% Last Modified by GUIDE v2.5 11-Aug-2014 16:27:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GTBW_OpeningFcn, ...
                   'gui_OutputFcn',  @GTBW_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GTBW is made visible.
function GTBW_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GTBW (see VARARGIN)

% Choose default command line output for GTBW
...
% UIWAIT makes GTBW wait for user response (see UIRESUME)
% uiwait(handles.Main);


% --- Outputs from this function are returned to the command line.
function varargout = GTBW_OutputFcn(hObject, eventdata, handles) 
...
% --------------------------------------------------------------------
function psg_PowerSpectrumStage_Callback(hObject, eventdata, handles)
% hObject    handle to psg_PowerSpectrumStage2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
psg_PowerSpectrumStage(handles);

% --------------------------------------------------------------------
function psg_PowerSpectrumStage2_Callback(hObject, eventdata, handles)
% hObject    handle to psg_PowerSpectrumStage2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
psg_PowerSpectrumStage2(handles);
...
% --------------------------------------------------------------------
function psg_PowerSpectrumStage_Callback(hObject, eventdata, handles)
% hObject    handle to psg_PowerSpectrumStage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

function psg_PowerSpectrumStage_Callback2(hObject, eventdata, handles)
% hObject    handle to psg_PowerSpectrumStage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function psg_PowerSpectrumStage3_Callback(hObject, eventdata, handles)
psg_PowerSpectrumStage3(handles);
% hObject    handle to psg_PowerSpectrumStage3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
